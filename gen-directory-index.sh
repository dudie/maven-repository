...
<head>
  ...
  <style>
    ...
    a.type-f { background : url('data:image/png;base64, ') left top no-repeat; }
...
<body>
  ...
  <table>
    ...
    <tbody>
      <tr>
        <td><a href=\"$BASE_URL/$LOCATION/..\" class=\"icon up\">[parent directory]</a></td>
        <td></td>
        <td></td>
      </tr>" > $OUT
